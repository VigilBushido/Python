...
#               3. ask the user if they obtained a bonus (y/n) if y ask amount
#               4. weekly wage = 40 * rate_per_hour + (Hours-40) * rate_per_hour * 1.5
#               5. show the user his weekly pay & overtimepay
#                                                           
#   output: display weekly pay & overtime)
